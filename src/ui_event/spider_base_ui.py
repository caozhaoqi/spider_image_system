...
from ui_event.base_event import auto_start_spider_image, stop_spider_image, stop_download_image, edit_config_msg, \
    ...
    user_upload_image, user_download_image, unzip_file_method, api_main_method
...
def base_menu(self):
    ...
    self.web_api_menu = QAction('web服务', self.tools_menu)
    ...
    self.web_api_menu.triggered.connect(lambda: api_main_method())
    ...
    self.tools_menu.addAction(self.web_api_menu)
